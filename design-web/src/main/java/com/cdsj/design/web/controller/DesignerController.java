...
public class DesignerController {
    ...
    public DesignResponse<TbMgrDesigner> createDesigner(@RequestBody TbMgrDesigner tbMgrDesigner){
    ...
    public DesignResponse<TbMgrDesigner> removeDesigner(@PathVariable("loginid") Long desNo){
        try {
            ...
            return DesignResponse.result(ResultEnum.FAIL, desNo);
        }

        return DesignResponse.result(ResultEnum.SUCCESS, desNo);
    }
    ...
    public DesignResponse<TbMgrDesigner> queryPage(@RequestParam(value = "pageNo", defaultValue = "1") Integer pageNo,
        ...
        return DesignResponse.result(ResultEnum.SUCCESS, pageInfo);
    }
